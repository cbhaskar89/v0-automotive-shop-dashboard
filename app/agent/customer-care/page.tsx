  ...
  const [cases, setCases] = useState([
    {
      ...
      files: [
        { name: "diagnostic_log.pdf", size: "2.4 MB", uploadedBy: "Alex Rodriguez", uploadedAt: "2024-01-20 09:20" },
        {
      ...
      timeline: [
        { action: "Case created", user: "Alex Rodriguez", role: "Agent", timestamp: "2024-01-20 09:15" },
        { action: "Files uploaded", user: "Alex Rodriguez", role: "Agent", timestamp: "2024-01-20 09:20" },
    ...
    },
    {
      ...
      customerInfo: {
        ...
        company: "Private Owner",
        address: "5678 Pine Avenue, Los Angeles, CA 90210",
        customerType: "End Customer",
      ...
      files: [
        { name: "canopy_damage.jpg", size: "3.2 MB", uploadedBy: "Jessica Chen", uploadedAt: "2024-01-19 14:25" },
      ...
      timeline: [
        { action: "Case created", user: "Jessica Chen", role: "Agent", timestamp: "2024-01-19 14:20" },
        { action: "Damage photos uploaded", user: "Jessica Chen", role: "Agent", timestamp: "2024-01-19 14:25" },
    ...
    },
    {
      ...
      timeline: [
        { action: "Case created", user: "Marcus Johnson", role: "Agent", timestamp: "2024-01-18 11:30" },
          ...
          <TabsContent value="analytics" className="space-y-6">
                  ...
                  <div className="h-[300px] space-y-4">
                    <div className="space-y-3">
                      {[
                        {
                          label: "Open",
                          count: getFilteredData().statusBreakdown.open,
                          color: "bg-green-500",
                          percentage: Math.round(
                            (getFilteredData().statusBreakdown.open / getFilteredData().statusBreakdown.total) * 100,
                          ),
                        },
                        {
                          label: "In Progress",
                          count: getFilteredData().statusBreakdown.inProgress,
                          color: "bg-yellow-500",
                          percentage: Math.round(
                            (getFilteredData().statusBreakdown.inProgress / getFilteredData().statusBreakdown.total) *
                              100,
                          ),
                        },
                        {
                          label: "Escalated",
                          count: getFilteredData().statusBreakdown.escalated,
                          color: "bg-red-500",
                          percentage: Math.round(
                            (getFilteredData().statusBreakdown.escalated / getFilteredData().statusBreakdown.total) *
                              100,
                          ),
                        },
                        {
                          label: "Closed",
                          count: getFilteredData().statusBreakdown.closed,
                          color: "bg-gray-500",
                          percentage: Math.round(
                            (getFilteredData().statusBreakdown.closed / getFilteredData().statusBreakdown.total) * 100,
                          ),
                        },
                      ].map((status, index) => (
                        <div key={index} className="space-y-2">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-3">
                            <div
                              className={`h-3 rounded-full ${status.color} transition-all duration-500`}
                    ...
                    <div className="pt-4 border-t">
                      <div className="text-sm text-muted-foreground">
                        Total Cases: {getFilteredData().statusBreakdown.total}
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Calendar view showing daily SLA breaches - click any day to drill down
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>1-2 breaches</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 bg-orange-300 rounded" />
                        <span>3-4 breaches</span>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-7 gap-1">
                    {getFilteredData().slaHeatmapData.map((day, index) => (
                      <div
                        key={index}
                        className={`aspect-square rounded cursor-pointer hover:ring-2 hover:ring-blue-500 flex items-center justify-center text-xs font-medium transition-all ${
                          day.breaches === 0
                        ...
                        title={`${day.date} Jan: ${day.breaches} breaches`}
                      >
                        {day.date}
                      </div>
                    ))}
                  ...
                  <div className="flex justify-between items-center pt-4 border-t">
                    <div className="text-sm text-muted-foreground">
                      ...
                      {getFilteredData().slaHeatmapData.reduce((sum, day) => sum + day.breaches, 0)}
                    </div>
                    <div className="flex gap-2">
