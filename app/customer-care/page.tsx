  ...
  const [cases, setCases] = useState([
    {
      ...
      files: [
        {
          name: "diagnostic_log.pdf",
          size: "2.4 MB",
          uploadedBy: "Pieter Van Der Berg",
      ...
      timeline: [
        { action: "Case created", user: "Pieter Van Der Berg", role: "Repairer", timestamp: "2024-01-20 09:15" },
        { action: "Files uploaded", user: "Pieter Van Der Berg", role: "Repairer", timestamp: "2024-01-20 09:20" },
    ...
    },
    {
      ...
      files: [
        { name: "canopy_damage.jpg", size: "3.2 MB", uploadedBy: "Marie Dubois", uploadedAt: "2024-01-19 14:25" },
      ...
      timeline: [
        { action: "Case created", user: "Marie Dubois", role: "Repairer", timestamp: "2024-01-19 14:20" },
        { action: "Damage photos uploaded", user: "Marie Dubois", role: "Repairer", timestamp: "2024-01-19 14:25" },
    ...
    },
    {
      ...
      timeline: [
        { action: "Case created", user: "Luc Janssen", role: "Repairer", timestamp: "2024-01-18 11:30" },
